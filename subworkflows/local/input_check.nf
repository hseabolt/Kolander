...
// Credit: nf-core/mag and modified for this pipeline
//
...
workflow INPUT_CHECK {
        ...
        ch_input_rows = Channel
            ...
            .map { row ->
                    if (row.size() == 6) {
                        ...
                        return [ id, group, sr1, sr2, lr, fasta ]
                    } else {
    ...
    ch_input_rows
        .map { id, group, sr1, sr2, lr, fasta -> id }
        .toList()
